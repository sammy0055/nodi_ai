...
export enum OrderFlowStep {
  ...
  CUSTOMER_NAME_COLLECTION = 'CUSTOMER_NAME_COLLECTION',
  SERVICE_SELECTION = 'SERVICE_SELECTION',
  ADDRESS_SELECTION = 'ADDRESS_SELECTION',
  CATALOG_SELECTION = 'CATALOG_SELECTION',
  CUSTOMIZE_ORDER_SELECTION = 'CUSTOMIZE_ORDER_SELECTION',
  PRODUCT_ITEMS_SELECTION = 'PRODUCT_ITEMS_SELECTION',
  PRODUCT_OPTIONS = 'PRODUCT_OPTIONS',
  OPTIONS_ITEM_COLLECTION = 'OPTIONS_ITEM_COLLECTION',
  ORDERED_ITEM_COLLECTION = 'ORDERED_ITEM_COLLECTION',
  ORDERED_ITEM_OPTIONS_COLLECTION = 'ORDERED_ITEM_OPTIONS_COLLECTION',
  UPSELLING = 'UPSELLING',
  UPSELLING_OPTIONS_ITEM_COLLECTION = 'UPSELLING_OPTIONS_ITEM_COLLECTION',
  ORDER_SUMMARY = 'ORDER_SUMMARY',
  ORDER_COMPLETION = 'ORDER_COMPLETION',
  EDIT_ORDER_ACTION_COLLECTION = 'EDIT_ORDER_ACTION_COLLECTION',
  REMOVE_ORDERED_ITEMS_COLLECTION = 'REMOVE_ORDERED_ITEMS_COLLECTION',
  PRODUCT_INVENTORY_CHECK_SELECTION = "PRODUCT_INVENTORY_CHECK_SELECTION"
}
