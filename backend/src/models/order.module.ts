...
OrderModel.init(
  {
    ...
    deliveryAreaName: { type: DataTypes.STRING, allowNull: false },
    deliveryZoneId: { type: DataTypes.STRING, allowNull: false },
    deliveryZoneName: { type: DataTypes.STRING, allowNull: false },
